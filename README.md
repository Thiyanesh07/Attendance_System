...
| **Students** | roll_number, name, department, face_encoding |
| **Attendance** | student_id, timestamp, camera_id |
| **Cameras** | name, stream_url, location, resolution |
| **Messages** | sender_id, subject, message, admin_reply |

## 🔌 Frontend Components

| Component | Purpose |
|-----------|----------|
| **HomePage** | Login and authentication |
| **AdminDashboard** | Admin control panel |
| **StudentDashboard** | Student view portal |
| **StudentsManagement** | CRUD operations for students |
| **AttendanceManagement** | View and export attendance |
| **CamerasManagement** | Camera configuration |
| **LiveMonitoring** | Real-time recognition interface |
| **Messaging** | Communication hub |
| **UserManagement** | Role and permission control |

## 🛠️ Common Issues

| Issue | Solution |
|-------|----------|
| Google Auth Fails | Check Client ID in `.env` file |
| Camera Not Detected | Verify camera permissions in browser |
